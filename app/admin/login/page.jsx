...
export default function AdminLogin() {
  ...
  const $ = {
    ...
    card: { background: "#12121a", border: "1px solid #1e1e2e", borderRadius: 16, padding: 28 },
    ...
    <div style={$.app}>
      ...
      <div style={{ position: "relative", zIndex: 1, width: 420 }}>
        <div style={{ textAlign: "center", marginBottom: 32 }}>
          ...
          <p style={{ color: "#444", margin: "8px 0 0", fontSize: 13 }}>بوابة السوبر أدمن — إدارة النظام الكاملة</p>
        </div>
        <div style={{ ...$.card, boxShadow: "0 40px 80px #00000099" }}>
          <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            <div>
              ...
              <input style={$.inp} type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="superadmin@smartcv.ae" />
            </div>
            <div>
            ...
            {error && (
              <div style={{ background: "#4c051933", borderRadius: 10, padding: 12, border: "1px solid #dc262644", color: "#f87171", fontSize: 13 }}>
                {error}
              </div>
            )}
